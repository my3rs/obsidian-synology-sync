...
This plugin is an open-source, third-party tool designed to synchronize Obsidian notes with your Synology NAS via the official Synology Drive API. By using this plugin, you acknowledge and agree to the following:
